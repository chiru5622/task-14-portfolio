...
export default function AboutCard() {
  return (
    <section className="flex justify-center items-center  px-6 py-8 bg-white rounded-3xl shadow-xl  mx-auto">
      ...
      <div className="flex flex-col items-center w-1/2">
        <div className="relative">
          ...
          <div className="absolute left-1/2 -bottom-6 -translate-x-1/2 flex gap-3 bg-white rounded-xl shadow-lg px-5 py-2">
            ...
            <a href="#" className="bg-purple-600 text-white rounded px-2 py-1 text-xl">
